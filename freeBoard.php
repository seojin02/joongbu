			...
			<div class="row">
				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					<div class="blog_left_sidebar">
						...
						<div style="border-top: 1px solid #ebebea;margin-top:10px;margin-bottom:10px;"></div>
						<?
						...
						<div class="form-group text-right mt-3">
							<a href="freeBoardMyPage.php?page=1">
								<button type="submit" class="button button-contactForm btn_2">나의 글 확인</button>
							</a>

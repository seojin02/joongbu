<?php
  ...
  $client_secret = "Vn2qGxrYuD";
  $code = $_GET["code"];;
  $state = $_GET["state"];;
  $redirectURI = urlencode("./naverOAuth.php");
...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
	...
	<section class="blog_area section_padding" style="min-height:450px;padding: 100px 0px;">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<form action="naverValidation.php" method="post" enctype="multipart/form-data" role="form">
						<!-- Banner -->
						<div class="container">
							<div class="row main">

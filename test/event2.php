...
<html lang="ko" dir="ltr">
  <head>
    ...
    <meta property="og:image" content="www/img/meta/kakao_link.png">
    ...
    <link rel="stylesheet" type="text/css" href="www/css/common.css?ver=<?=Ver?>"/>
    <link rel="stylesheet" type="text/css" href="www/css/event2.css?ver=<?=Ver?>"/>
  ...
  <body>
    <center>
        <div class="header">
          <img src="www/img/header_2.png" alt="uplusxNetflix Header Image" usemap="#header">
        </div>

...
<link rel="stylesheet" href="css/style.css">
	...
	<!--================Content Area =================-->
	<section class="blog_area section_padding" style="min-height:800px;padding: 50px 0px;">
		<div class="container">
			<h2><b>회원가입</b></h2>
			<div class="row">
				<div class="col-lg-12">
					<form action="api/member_ok.php" method="post" enctype="multipart/form-data" role="form">
						<!-- Banner -->
						<div class="container">
							<div class="row main">
								...
								<h2 class="title" align="center"> YANG에 오신 것을 환영합니다. </h1><br>

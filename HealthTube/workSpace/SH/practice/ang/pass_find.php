...
?>
	...
	<!--================Content Area =================-->
	<section class="blog_area section_padding" style="min-height:150px;padding: 30px 0px;">
		<div class="container">
			<h2><b>비밀번호 찾기</b></h2>
			<div class="row">
				<div class="col-lg-12">
					<form name = "frm1" action="api/pass_find_ok.php" method="post" enctype="multipart/form-data" role="form">
						<!-- Banner -->
						<div class="container">
							<div class="row main">

    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">수훈전용</a></div>

          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="#home-section" class="nav-link">홈</a></li>
                <li><a href="#courses-section" class="nav-link">게시판</a></li>
                <li><a href="#programs-section" class="nav-link">일정</a></li>
                <li><a href="#teachers-section" class="nav-link">유튜브</a></li>
								<li><a href="#teachers-section" class="nav-link">구글</a></li>
								<li><a href="#teachers-section" class="nav-link">네이버</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="#contact-section" class="nav-link"><span>연락주세요</span></a></li>
              </ul>
            </nav>
